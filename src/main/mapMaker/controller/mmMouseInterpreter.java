...
public class mmMouseInterpreter {
    ...
    public mmMouseInterpreter(int canvasWidth, int canvasHeight, int assetHeight, int assetWidth){
    ...
    public mmLocation interpretMouseClick(double x, double y){
        int xx = 0;
        int yy = 0;
        ...
        mmLocation mmLocation = null;
        try{
            // convert from axial to cube
            mmLocation = new mmLocation(xx,-xx-yy ,yy);
        } catch(Exception e){
            e.printStackTrace();
        }
        return mmLocation;
